  ...
  const handleEditNFSe = async (nfseId: string) => {
    try {
      ...
      const formData: NFSeFormData = {
        ...
        tipo_registro: data.tipo_registro || "2",
        ...
        tipo_endereco_tomador: data.tipo_endereco_tomador || "",
        ...
        tipo_documento_intermediario: data.tipo_documento_intermediario || "",
        documento_intermediario: data.documento_intermediario || "",
        inscricao_municipal_intermediario: data.inscricao_municipal_intermediario || "",
        razao_social_intermediario: data.razao_social_intermediario || "",
        ...
        repasse_plano_saude: data.repasse_plano_saude || 0,
        ...
        fonte_carga_tributaria: data.fonte_carga_tributaria || "",
        cei: data.cei || "",
        matricula_obra: data.matricula_obra || "",
        municipio_prestacao: data.municipio_prestacao || "",
        municipio_prestacao_codigo: data.municipio_prestacao_codigo || "",
        situacao_aceite: data.situacao_aceite || "",
        encapsulamento: data.encapsulamento || "",
        valor_total_recebido: data.valor_total_recebido || 0,
        tipo_consolidacao: data.tipo_consolidacao || "",
        nfse_consolidada: data.nfse_consolidada || "",
        ...
        responsavel_retencao: data.responsavel_retencao || "tomador",
        ...
        codigo_regime_especial_tributacao: data.codigo_regime_especial_tributacao || null,
